   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid63", tween: [ "style", "${_orangeText_mc}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
...
"yellowText_mc": {
   ...
   },
   {
      ...
      id: 'Text9',
      text: 'For a new member of academic staff, getting into the university culture as soon as possible is critical. In this section, we will look at some of the more practical aspects of getting you started into the learning and teaching culture at USQ. The information it contains is intended to be direct, concise and above all practical. <br><br>If you are a new member of academic staff, with limited or no experience in tertiary teaching, the order of topics shown above is recommended for you to undertake. It serves as a quick reference guide with some tips and exercises to get you started and to enable you to hit the ground running.<br>',
      align: 'left',
      transform: []
   }],
   symbolInstances: [
