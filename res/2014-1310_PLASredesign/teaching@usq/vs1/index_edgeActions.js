...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_red2_mc}", "click", function(sym, e) {
         ...
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1838", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_blue2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1835", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_purple2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1836", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_teal2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1834", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pink2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1837", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_green2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1833", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_orange2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701", "_top");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_dGreen2_mc}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1832", "_top");
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_proceed_btn}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("http://mystaffdesk.usq.edu.au/moodle2/mod/book/view.php?id=36701&chapterid=1831", "_top");
